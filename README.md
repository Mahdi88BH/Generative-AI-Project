...
## 🧠 3. Workflow de l'Agent (Chain-of-Thought)
...
## 🚦 4. Protocole de Déploiement (Ordre Critique)
...
<table width="100%">
  ...
  <tr>
    ...
    <td align="center">Port <b>8010</b><br><i>(Outils OCR)</i></td>
  </tr>
  <tr>
    <td align="center"><b>2</b></td>
    <td><b>Nexus Core (API)</b></td>
    <td><code>python ai_engine/main.py</code></td>
    <td align="center">Port <b>8001</b><br><i>(Graphe IA)</i></td>
  </tr>
  <tr>
    <td align="center"><b>3</b></td>
    <td><b>Web UI Dashboard</b></td>
    <td><code>python manage.py runserver</code></td>
    <td align="center">Port <b>8000</b><br><i>(Interface)</i></td>
  </tr>
</table>

---

## ⚙️ 5. Configuration Système
...
<table width="100%">
  ...
  <tr>
    ...
    <td>Clé API pour l'inférence ultra-rapide du modèle Llama 3.3.<br><i>Exemple : <code>gsk_abc123...</code></i></td>
  </tr>
  <tr>
    <td><code>TESSERACT_PATH</code></td>
    <td align="center">🟡 <b>Windows</b></td>
    <td>Chemin absolu vers le binaire Tesseract pour le module Vision.<br><i>Exemple : <code>C:\Program Files\Tesseract-OCR\tesseract.exe</code></i></td>
  </tr>
</table>

---

## 👨‍💻 6. Acteurs & Exploitation
...
<table width="100%">
  ...
  <tr>
    ...
    <td>© 2026 Nexus AI - Engineering Intelligence for the Future of Education.<br><i>Développé avec rigueur pour l'excellence académique.</i></td>
  </tr>
</table>